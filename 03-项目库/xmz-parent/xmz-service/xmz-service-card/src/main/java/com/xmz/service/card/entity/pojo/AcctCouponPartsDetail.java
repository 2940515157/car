...
@Data
  @EqualsAndHashCode(callSuper = false)
    @ApiModel(value="AcctCouponPartsDetail对象", description="优惠券配件明细")
public class AcctCouponPartsDetail implements Serializable {

    private static final long serialVersionUID = 1L;

      @ApiModelProperty(value = "主键ID")
        @TableId(value = "ACPD_UUID", type = IdType.ASSIGN_UUID)
