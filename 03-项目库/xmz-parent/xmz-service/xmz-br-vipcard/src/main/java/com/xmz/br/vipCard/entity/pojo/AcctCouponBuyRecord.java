...
@Data
  @EqualsAndHashCode(callSuper = false)
    @ApiModel(value="AcctCouponBuyRecord对象", description="优惠券购买及消费跟踪")
public class AcctCouponBuyRecord implements Serializable {
    ...
    private BigDecimal salPrice;
      ...
      @ApiModelProperty(value = "实收金额 现金、pos、微信支付:等于售价\n" +
              "储值卡支付：=售价*支付时的折扣率 acct_rev_pay_items.discount_rate")
